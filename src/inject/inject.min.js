			...
			new class {
				constructor() {
					...
					for (var x = 0, max = this.inputs.length; x < max; x++) {
						...
						input.addEventListener('keyup', this.listener(event));
					}
				}
